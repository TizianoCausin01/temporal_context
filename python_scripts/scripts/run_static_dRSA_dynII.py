...
# e.g. to call it:
# mpiexec -np 5 python3 run_static_dRSA_dyn.py --monkey_name=three0 --date=250313 --brain_area=AIT --folder_name=talia_20each_tizi --signal_RDM_metric=cosine --model_RDM_metric=euclidean --model_name=vit_l_16 --img_size=384 --pooling=mean --new_fs=100 --k=1 --pkg=timm
